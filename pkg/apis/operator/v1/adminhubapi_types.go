...
// AdminHubApi is the Schema for the adminhubapis API
// +kubebuilder:subresource:status
// +kubebuilder:resource:path=adminhubapis,scope=Namespaced
...
func init() {
	SchemeBuilder.Register(&AdminHubApi{}, &AdminHubApiList{})
}
